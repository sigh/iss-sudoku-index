// Title: Chess Variation Sudoku = almost Unbelievable
// Author: Cam Dennis
// Video: https://www.youtube.com/watch?v=h9wQ73F8Cqc
...
// the Knight Sudoku extra rule from the video description: identical digits
// cannot be a chess knight's move apart, anywhere in the grid. The same
// description also offers King Sudoku and Queen Sudoku (9s only,
// queen's-move) as independently-sufficient alternative readings of this
// same grid; only Knight -- the rule the description states plainly first,
// with King and Queen each marked "alternatively" to it -- is encoded here.
return [
  new Shape('9x9'),
