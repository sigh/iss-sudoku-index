...
// Source: http://pzv.jp/p.html?akari/10/10/hap.cl1.hc1.n.bp0.n..hc1.n.bpb
...
// "shading as a widened Raw grid" technique used for this pipeline's
// Slitherlink rows. There is no separate "is illuminated" overlay: a white
// cell's row-run and column-run (the maximal stretch of white cells either
// side of it, up to the nearest wall or edge) are computed directly from the
// fixed wall layout, and illumination becomes "at least one cell in that
// union is a bulb" -- a single Or of Given(cell, BULB) branches, one branch
// per candidate cell, which is trivially true when the cell is itself a
// bulb.
...
// The 20 black cells, transcribed from the source's own clue table
