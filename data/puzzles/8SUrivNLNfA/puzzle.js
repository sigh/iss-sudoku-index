// Title: The Gallery
// Author: Riffclown
// Video: https://www.youtube.com/watch?v=8SUrivNLNfA
...
const regions = [
  ...
  ['R2C2', 'R2C3', 'R3C2', 'R3C3', 'R3C4', 'R4C3', 'R5C1', 'R5C2', 'R5C3'],
  ['R4C4', 'R4C5', 'R4C6', 'R5C4', 'R5C5', 'R5C6', 'R6C4', 'R6C5', 'R6C6'],
  ['R5C7', 'R5C8', 'R5C9', 'R6C7', 'R7C6', 'R7C7', 'R7C8', 'R8C7', 'R8C8'],
  ['R6C1', 'R6C2', 'R7C1', 'R8C1', 'R8C4', 'R9C1', 'R9C2', 'R9C3', 'R9C4'],
  ['R6C3', 'R7C2', 'R7C3', 'R7C4', 'R7C5', 'R8C2', 'R8C3', 'R8C5', 'R9C5'],
...
// Drawn gold Nabner loops; PairX applies this predicate to every pair on each loop.
const nabnerKey = PairX.fnToKey((a, b) => Math.abs(a - b) > 1, 9);
const nabners = [
  new PairX(nabnerKey, 'Nabner', 'R8C7', 'R8C8', 'R7C8', 'R7C7'),
  new PairX(nabnerKey, 'Nabner', 'R3C2', 'R3C3', 'R2C3', 'R2C2'),
];
