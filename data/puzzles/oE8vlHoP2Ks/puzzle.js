// Title: Top Heavy 21 Dice
// Author: John Bulten
// Video: https://www.youtube.com/watch?v=oE8vlHoP2Ks
// Source: https://app.crackingthecryptic.com/sudoku/bbpjHpN9JP

// Plain Fillomino, 10x10. There is no Sudoku layer, so the grid is Raw: rows,
// columns and boxes carry no rule and values repeat freely.
//
// Rules encoded:
//  * Fillomino. Divide the grid into regions of orthogonally connected
//    cells; each cell's number equals the size of its own region; two
//    regions of equal size never share an orthogonal edge (diagonal contact
//    is allowed).
//  * The 21 given numbers.
//
...
// same split-number/root/depth construction already used for other 10x10+
// Fillomino rows in this pipeline (e.g. data/puzzles/ZrfTSUxm0iE/puzzle.js).
...
// Transcribed from the 21 numbers printed in the grid: [row, col, number].
const GIVENS = [
  [1, 1, 5], [1, 2, 4], [1, 4, 6], [1, 9, 5], [1, 10, 6],
  [2, 5, 5], [2, 8, 3],
  [4, 1, 6], [4, 7, 6],
  [5, 2, 5], [5, 8, 2], [5, 10, 5],
  [6, 6, 5],
