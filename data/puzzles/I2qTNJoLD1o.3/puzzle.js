...
// Source: http://pzv.jp/p.html?fillomino/10/10/43l5543l25h44h27j63h45l56n78l77h75j33h75h47l2544l44
...
//    cell holds the size of its region, so the numbers within a region are
//    all the same and equal to the region's size; regions of equal size do
//    not share an orthogonal edge (diagonal contact is allowed). A region may
//    contain zero, one or more of the given numbers.
//  * The 36 given numbers.
//
// Nothing is omitted. Nothing caps a region below the board's own 100 cells,
...
// Transcribed from the 36 numbers printed in the grid: [row, col, number].
const GIVENS = [
  [1, 1, 4], [1, 2, 3], [1, 9, 5], [1, 10, 5],
  [2, 1, 4], [2, 2, 3], [2, 9, 2], [2, 10, 5],
  [3, 3, 4], [3, 4, 4], [3, 7, 2], [3, 8, 7],
  [4, 3, 6], [4, 4, 3], [4, 7, 4], [4, 8, 5],
  [5, 5, 5], [5, 6, 6],
  [6, 5, 7], [6, 6, 8],
  [7, 3, 7], [7, 4, 7], [7, 7, 7], [7, 8, 5],
  [8, 3, 3], [8, 4, 3], [8, 7, 7], [8, 8, 5],
  [9, 1, 4], [9, 2, 7], [9, 9, 2], [9, 10, 5],
  [10, 1, 4], [10, 2, 4], [10, 9, 4], [10, 10, 4],
];
